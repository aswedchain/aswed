...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			name: 'getBlocksByNumber',
			call: 'eth_getBlocksByNumber',
			params: 2,
			inputFormatter: [web3._extend.formatters.inputBlockNumberFormatter, web3._extend.formatters.inputBigNumberFormatter],
			outputFormatter: web3._extend.formatters.outputBlocksFormatter
		}),
		new web3._extend.Method({
			name: 'getBlockByHash',
