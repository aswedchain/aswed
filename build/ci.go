...
import (
	...
	"aswed.space/aswed/aswed/crypto/signify"
	"aswed.space/aswed/aswed/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "aswed.space/aswed/aswed/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "aswed.space/aswed/aswed/mobile")
